...
static INPUT_PORTS_START( charon )
	PORT_INCLUDE( system16b_generic )
	...
	PORT_DIPUNUSED_DIPLOC( 0x20, IP_ACTIVE_LOW, "SW2:6" )
	PORT_DIPUNUSED_DIPLOC( 0x40, IP_ACTIVE_LOW, "SW2:7" )
	PORT_DIPNAME( 0x80, 0x00, "Debug Menu" ) PORT_DIPLOCATION("SW2:8")
	PORT_DIPSETTING(    0x00, DEF_STR( Yes ) )
...
ROM_START( charon )
	ROM_REGION( 0x80000, "maincpu", 0 ) // 68000 code
	ROM_LOAD16_BYTE( "pro0e.a7", 0x00000, 0x20000, CRC(3cc9a447) SHA1(a54ff40a4fb54d84218c7cf94471a922efa97ce7) )
	ROM_LOAD16_BYTE( "pro0o.a5", 0x00001, 0x20000, CRC(64d1272e) SHA1(ab1bd54079333231deed5900de5e1b19ae3423f5) )
	...
	ROM_LOAD( "b1-1.b15", 0x60000, 0x20000, CRC(2c4ad599) SHA1(e5dbbad51c7d8b47ece8aff5b1a9ab824f0b0c35) )
	ROM_LOAD( "b0-2.a16", 0x80000, 0x20000, CRC(1313b1c9) SHA1(f5013bee752d23f89056bdac25744f6416f72d56) )
	ROM_LOAD( "b1-2.b16", 0xa0000, 0x20000, CRC(0ceca3bb) SHA1(916d8bcde3558b6704b078cfcd234f543fa86579) )

	ROM_REGION16_BE( 0x200000, "sprites", ROMREGION_ERASEFF ) // sprites
	ROM_LOAD16_BYTE( "obj-e0.b5", 0x000000, 0x20000, CRC(79ebeed0) SHA1(a76ca27f21ccc45bd00838994eb8c9fb47a5510e) )
	ROM_LOAD16_BYTE( "obj-o0.b1", 0x000001, 0x20000, CRC(45cd07e1) SHA1(1653c992be28052ace18b79e841d9228f8d3f18a) )
	ROM_LOAD16_BYTE( "obj-e1.b6", 0x040000, 0x20000, CRC(a001c80e) SHA1(699cb393b0d7307282de0c1cdb762a905a0bf81e) )
	ROM_LOAD16_BYTE( "obj-o1.b2", 0x040001, 0x20000, CRC(04e94a5b) SHA1(2c3d331b08288145bf24d34d3bec4cd0d7e29cf1) )
	ROM_LOAD16_BYTE( "obj-e2.b7", 0x080000, 0x20000, CRC(8fa36caf) SHA1(bc31c71cf349053bc01053b5ede49e524fba6102) )
	ROM_LOAD16_BYTE( "obj-o2.b3", 0x080001, 0x20000, CRC(63375cea) SHA1(864c21b9a1cb757764d4070c0e62d185e10af5db) )
	ROM_LOAD16_BYTE( "obj-e3.b8", 0x0c0000, 0x20000, CRC(61c7a7dc) SHA1(cca2ae9ef6d54e58f32283bec01109796db0c7cf) )
	ROM_LOAD16_BYTE( "obj-o3.b4", 0x0c0001, 0x20000, CRC(feaab056) SHA1(d681d22fccc375b2280e1fb98ce5fa6f69daa7a6) )
	ROM_LOAD16_BYTE( "obj-e4.b10", 0x100000, 0x20000, CRC(22233fd4) SHA1(79599d3d86fd4bc349eda677f14180ffdfa4d3c8) )
	ROM_LOAD16_BYTE( "obj-o4.a1", 0x100001, 0x20000, CRC(b1b4ef01) SHA1(f7e6c90a756532f40e56262761ad7fc273aa2c6e) )
	
	ROM_LOAD16_BYTE( "obj-o5.a2", 0x140001, 0x20000, CRC(b1b4ef01) SHA1(f7e6c90a756532f40e56262761ad7fc273aa2c6e) )


	ROM_REGION( 0x50000, "soundcpu", 0 ) // sound CPU
	ROM_LOAD( "spro.a10", 0x00000, 0x08000, CRC(8aa61955) SHA1(47964670c78d84133e533af299b9f7f3048700a5) )
	ROM_LOAD( "s0.a11", 0x10000, 0x20000, CRC(82a24191) SHA1(d7ff5671b98f63e5b50e8d3d7fc4b28dec8c5923) )
